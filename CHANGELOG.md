...
* add /api/* JSON endpoints for blocks/pool-stats/analysis/tip-info/health ([8949aa2](https://github.com/Snipa22/go-tari-explorer/commit/8949aa2de9d815e7881f14aedf3ed5d2f57906cc))
* add OpenAPI 3.0 spec for /api/* with served Swagger UI ([2cc4b49](https://github.com/Snipa22/go-tari-explorer/commit/2cc4b497d3ad2bf3df2c4415e09be8bcbe6d1913))
...
* **analysis:** add Rewards by Algo and Rewards by Pool views ([282dd26](https://github.com/Snipa22/go-tari-explorer/commit/282dd26ac8f7686d0258e664c33b3daf69cb97f7))
...
* **db:** capture coinbase reward value in reward_micro_minotari ([45b3a36](https://github.com/Snipa22/go-tari-explorer/commit/45b3a360aac4780655cc87a95e5570054745979d))
...
* **poolattr:** add bare Jagtech coinbase-extra prefix (WUF dropped) ([2f7423e](https://github.com/Snipa22/go-tari-explorer/commit/2f7423efd351ae720d6efd74f38b8a040465abe7))
...
* **reindex-rewards:** add one-shot GRPC backfill tool for reward_micro_minotari ([c5508db](https://github.com/Snipa22/go-tari-explorer/commit/c5508db5a3229588f830d1d550bd4ca688538873))
...
* **server:** source front-page current-difficulty column from template_difficulty_snapshots ([a810a61](https://github.com/Snipa22/go-tari-explorer/commit/a810a61e8758be998101b34fc6096682d737c16c))
...
* **templatepoller:** capture live per-algo next-block target difficulty ([b715d84](https://github.com/Snipa22/go-tari-explorer/commit/b715d84e287a415e75fb7b5562e477ced499cc8e))
...
* correct /api/docs dark-theme contrast and update openapi.yaml servers list ([ea3a541](https://github.com/Snipa22/go-tari-explorer/commit/ea3a54171d6afc98a0204100059834283a7cf3ad))
* cover parameter/response description text and input backgrounds in /api/docs dark theme ([0715fdc](https://github.com/Snipa22/go-tari-explorer/commit/0715fdc92bcedfc5880270774da9cd1ec65f1730))
...
* **poolattr:** correct bare Jagtech tagLen 12-&gt;9 (PR [#28](https://github.com/Snipa22/go-tari-explorer/issues/28) / 2f7423e) ([b580741](https://github.com/Snipa22/go-tari-explorer/commit/b580741cb05404ec0278aafd3b97f34fd6f6573a))
...
* **poolattr:** support NUL-delimited coinbase-extra tags ([660105b](https://github.com/Snipa22/go-tari-explorer/commit/660105b6bdb2c045fc7c42736d91104ee56a4cec))
...
* **server:** comma-group formatMicroMinotari's integer part ([b69382c](https://github.com/Snipa22/go-tari-explorer/commit/b69382c79795070168804491b2074546760fe100))
