...
See `LICENSE` at repo root (MIT). Repos generating from or deriving Tari core protobuf/source (e.g. `go-tari-grpc-lib`) inherit Tari core's license (BSD-3-Clause) instead — don't assume, check the actual `LICENSE` file for this repo.
