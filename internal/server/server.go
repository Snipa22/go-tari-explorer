...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("GET /analysis/rewards-by-algo", s.handleAnalysisRewardsByAlgo)
	mux.HandleFunc("GET /analysis/rewards-by-pool", s.handleAnalysisRewardsByPool)
	...
	mux.HandleFunc("GET /analysis/rewards-by-algo.png", s.handleAnalysisRewardsByAlgoPNG)
	mux.HandleFunc("GET /analysis/rewards-by-pool.png", s.handleAnalysisRewardsByPoolPNG)
